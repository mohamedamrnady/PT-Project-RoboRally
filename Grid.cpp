...
//
//
//		/*int type = pNewObject->GetObjType();
//		switch (type)
//		{
//		case flag:
//			if (numFlag == 0)
//				numFlag++;
//			else {
//				pOut->PrintMessage("Can't have more than one flag");
//				return false;
//			}
//			break;
//		case water_pit:
...
//				numAntennas++;
//			else {
//				pOut->PrintMessage("Can't have more than one antenna");
//				return false;
//			}
//			break;
//		case rotating_gear:
...
void Grid::SaveAll(ofstream& outfile, int type) { //saves all objects of a certain type
